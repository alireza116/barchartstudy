function init() {
    ...
    let refreshWrappedBarChart = function () {
        if (
            selected_numerical_col && selected_numerical_col
    ...
    let loadCSVFile = function () {
        let data = d3.csvParse(reader.result, function (d) { return d; });
    ...
    let clearChartDiv = function () {
        ...
        document.getElementById("thresh")
            .innerHTML = "<span class=\"badge badge-secondary col-md-5 p-2\">Bar Chart Threshold</span>";
        document.getElementById("wrap")
            .innerHTML = "<span class=\"badge badge-secondary col-md-5 p-2\">Wrap Threshold</span>"
    };
}